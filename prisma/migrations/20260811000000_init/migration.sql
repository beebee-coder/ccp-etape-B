...
CREATE TABLE IF NOT EXISTS procedures (
   ...
   criticality         VARCHAR(20) NOT NULL DEFAULT 'NORMAL' CHECK (criticality IN ('NORMAL','HIGH','CRITICAL')),
...
-- 5. MÉDIAS / IMAGES (actuel — server-store.ts)
...
-- 6. WORKFLOWS (aspirational — structure-bdd)
...
-- 7. WORKFLOW_STEPS (aspirational — structure-bdd)
...
-- 8. EXÉCUTIONS (aspirational — structure-bdd)
...
-- 9. INTÉGRATIONS (aspirational — structure-bdd)
...
-- 10. AUDIT_LOGS (aspirational — structure-bdd)
...
-- 21. NOEUDS DE LOCALISATION (referentiel)
